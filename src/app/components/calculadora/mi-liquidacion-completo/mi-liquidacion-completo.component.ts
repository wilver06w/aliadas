...
@Component({
  selector: 'app-mi-liquidacion-completo',
  templateUrl: './mi-liquidacion-completo.component.html',
  styleUrls: ['./mi-liquidacion-completo.component.css']
})
export class MiLiquidacionCompletoComponent {
